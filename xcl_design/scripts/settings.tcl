namespace eval ZQ {
  ...
  # -----------------------------------
  # check csv file ids
  variable SCRIPTVER    "2016.atm.09"
  ...
  # -----------------------------------------
    ...
    proc init_pathvar {} {
      ...
      set ZQ::VPROJ_PATH [pwd]/vivado/xcl_design
      ...
      # --
      set ZQ::LOG_PATH [pwd]/v_log/xcl_design
    ...
    proc check_bdtyp {} {
      ...
      foreach bd $bd_files {
        ...
        if {[string match *xcl_design* $ZQ::BD_TCLNAME ]} {set ZQ::IS_xcl_design true; puts "ZQ::IS_xcl_design:$ZQ::IS_xcl_design"
          ...
          puts "\"*xcl_design*.tcl\" for Systems with Zynq "
