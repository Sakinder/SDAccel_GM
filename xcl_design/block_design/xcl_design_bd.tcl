...
proc create_hier_cell_pr_support_expanded { parentCell nameHier } {
  ...
  set concat_flash_dq_o [ create_bd_cell -type ip -vlnv xilinx.com:ip:xlconcat:2.1 concat_flash_dq_o ]
  set_property -dict [ list \
CONFIG.NUM_PORTS {4} \
 ] $concat_flash_dq_o

  # Create instance: concat_flash_tri, and set properties
  set concat_flash_tri [ create_bd_cell -type ip -vlnv xilinx.com:ip:xlconcat:2.1 concat_flash_tri ]
  set_property -dict [ list \
CONFIG.NUM_PORTS {4} \
 ] $concat_flash_tri

  # Create instance: debug_bridge_xsdbm, and set properties
  set debug_bridge_xsdbm [ create_bd_cell -type ip -vlnv xilinx.com:ip:debug_bridge:1.1 debug_bridge_xsdbm ]
  set_property -dict [ list \
...
CONFIG.C_USE_STARTUP_INT {0} \
  ...
  set slice_ss_0 [ create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:1.0 slice_ss_0 ]
  set_property -dict [ list \
CONFIG.DIN_FROM {0} \
CONFIG.DIN_TO {0} \
CONFIG.DIN_WIDTH {2} \
  ...
  set slice_ss_1 [ create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:1.0 slice_ss_1 ]
  set_property -dict [ list \
CONFIG.DIN_FROM {1} \
CONFIG.DIN_TO {1} \
CONFIG.DIN_WIDTH {2} \
...
proc create_hier_cell_memc { parentCell nameHier } {
  ...
  set axicc_ddrmem_2_ctrl [ create_bd_cell -type ip -vlnv xilinx.com:ip:axi_clock_converter:2.1 axicc_ddrmem_2_ctrl ]

  # Create instance: axicc_ddrmem_3_ctrl, and set properties
  set axicc_ddrmem_3_ctrl [ create_bd_cell -type ip -vlnv xilinx.com:ip:axi_clock_converter:2.1 axicc_ddrmem_3_ctrl ]

  # Create instance: concat_ddrcalib, and set properties
  set concat_ddrcalib [ create_bd_cell -type ip -vlnv xilinx.com:ip:xlconcat:2.1 concat_ddrcalib ]
  set_property -dict [ list \
CONFIG.NUM_PORTS {4} \
 ] $concat_ddrcalib

  # Create instance: ddrmem_0, and set properties
  set ddrmem_0 [ create_bd_cell -type ip -vlnv xilinx.com:ip:ddr4:2.1 ddrmem_0 ]
  set_property -dict [ list \
...
CONFIG.C0.DDR4_isCustom {false} \
  ...
  set ddrmem_1 [ create_bd_cell -type ip -vlnv xilinx.com:ip:ddr4:2.1 ddrmem_1 ]
  set_property -dict [ list \
CONFIG.C0.ControllerType {DDR4_SDRAM} \
CONFIG.C0.DDR4_AxiAddressWidth {32} \
CONFIG.C0.DDR4_AxiDataWidth {512} \
...
CONFIG.C0.DDR4_isCustom {false} \
  ...
  set ddrmem_2 [ create_bd_cell -type ip -vlnv xilinx.com:ip:ddr4:2.1 ddrmem_2 ]
  set_property -dict [ list \
CONFIG.C0.ControllerType {DDR4_SDRAM} \
CONFIG.C0.DDR4_AxiAddressWidth {32} \
CONFIG.C0.DDR4_AxiDataWidth {512} \
...
CONFIG.C0.DDR4_isCustom {false} \
  ...
  set ddrmem_3 [ create_bd_cell -type ip -vlnv xilinx.com:ip:ddr4:2.1 ddrmem_3 ]
  set_property -dict [ list \
CONFIG.C0.ControllerType {DDR4_SDRAM} \
CONFIG.C0.DDR4_AxiAddressWidth {32} \
CONFIG.C0.DDR4_AxiDataWidth {512} \
...
CONFIG.C0.DDR4_isCustom {false} \
  ...
  set logic_ddrcalib_op [ create_bd_cell -type ip -vlnv xilinx.com:ip:util_reduced_logic:2.0 logic_ddrcalib_op ]
  set_property -dict [ list \
...
proc create_hier_cell_interconnect { parentCell nameHier } {
  ...
  set interconnect_aximm_ddrmem0 [ create_bd_cell -type ip -vlnv xilinx.com:ip:smartconnect:1.0 interconnect_aximm_ddrmem0 ]
  set_property -dict [ list \
...
CONFIG.NUM_CLKS {3} \
  ...
  set interconnect_aximm_ddrmem1 [ create_bd_cell -type ip -vlnv xilinx.com:ip:smartconnect:1.0 interconnect_aximm_ddrmem1 ]
  set_property -dict [ list \
CONFIG.ADVANCED_PROPERTIES { subcore_assignments { s*_entry_pipeline/s*_mmu { CONFIG.ENABLE_PIPELINING 0x0 CONFIG.SUPPORTS_WRITE_DECERR 0 CONFIG.SUPPORTS_READ_DECERR 0 } m*_exit_pipeline/m*_exit { CONFIG.ENABLE_PIPELINING 0x0 } s00_nodes/s00_r_node { CONFIG.FIFO_TYPE 1 CONFIG.FIFO_SIZE 9 } s00_nodes/s00_w_node { CONFIG.FIFO_TYPE 1 CONFIG.FIFO_SIZE 9 } s01_entry_pipeline/s01_si_converter { CONFIG.READ_WATERMARK 0 CONFIG.WRITE_WATERMARK 0 } s01_nodes/s01_ar_node { CONFIG.ENABLE_PIPELINING 0x07 } s01_nodes/s01_r_node { CONFIG.ENABLE_PIPELINING 0x06 CONFIG.FIFO_TYPE 1 CONFIG.FIFO_SIZE 9 } s01_nodes/s01_aw_node { CONFIG.ENABLE_PIPELINING 0x07 } s01_nodes/s01_w_node { CONFIG.ENABLE_PIPELINING 0x07 CONFIG.FIFO_TYPE 1 CONFIG.FIFO_SIZE 9 } s01_nodes/s01_b_node { CONFIG.ENABLE_PIPELINING 0x06 } m00_nodes/m00_r_node { CONFIG.ENABLE_PIPELINING 0x03 } } } \
CONFIG.NUM_CLKS {3} \
  ...
  set interconnect_aximm_ddrmem2 [ create_bd_cell -type ip -vlnv xilinx.com:ip:smartconnect:1.0 interconnect_aximm_ddrmem2 ]
  set_property -dict [ list \
...
CONFIG.NUM_CLKS {3} \
  ...
  set interconnect_aximm_ddrmem3 [ create_bd_cell -type ip -vlnv xilinx.com:ip:smartconnect:1.0 interconnect_aximm_ddrmem3 ]
  set_property -dict [ list \
CONFIG.ADVANCED_PROPERTIES { subcore_assignments { s*_entry_pipeline/s*_mmu { CONFIG.ENABLE_PIPELINING 0x0 CONFIG.SUPPORTS_WRITE_DECERR 0 CONFIG.SUPPORTS_READ_DECERR 0 } m*_exit_pipeline/m*_exit { CONFIG.ENABLE_PIPELINING 0x0 } s00_nodes/s00_ar_node { CONFIG.ENABLE_PIPELINING 0x07 } s00_nodes/s00_r_node { CONFIG.ENABLE_PIPELINING 0x06 CONFIG.FIFO_TYPE 1 CONFIG.FIFO_SIZE 9 } s00_nodes/s00_aw_node { CONFIG.ENABLE_PIPELINING 0x07 } s00_nodes/s00_w_node { CONFIG.ENABLE_PIPELINING 0x07 CONFIG.FIFO_TYPE 1 CONFIG.FIFO_SIZE 9 } s00_nodes/s00_b_node { CONFIG.ENABLE_PIPELINING 0x06 } s01_nodes/s01_ar_node { CONFIG.ENABLE_PIPELINING 0x07 } s01_entry_pipeline/s01_si_converter { CONFIG.READ_WATERMARK 0 CONFIG.WRITE_WATERMARK 0 } s01_nodes/s01_r_node { CONFIG.ENABLE_PIPELINING 0x06 CONFIG.FIFO_TYPE 1 CONFIG.FIFO_SIZE 9 } s01_nodes/s01_aw_node { CONFIG.ENABLE_PIPELINING 0x07 } s01_nodes/s01_w_node { CONFIG.ENABLE_PIPELINING 0x07 CONFIG.FIFO_TYPE 1 CONFIG.FIFO_SIZE 9 } s01_nodes/s01_b_node { CONFIG.ENABLE_PIPELINING 0x06 } m00_nodes/m00_r_node { CONFIG.ENABLE_PIPELINING 0x03 } } } \
CONFIG.NUM_CLKS {3} \
  ...
  set interconnect_aximm_host [ create_bd_cell -type ip -vlnv xilinx.com:ip:smartconnect:1.0 interconnect_aximm_host ]
  set_property -dict [ list \
...
CONFIG.C_EXT_RST_WIDTH {1} \
  ...
  set psreset_ddrmem_n_3 [ create_bd_cell -type ip -vlnv xilinx.com:ip:proc_sys_reset:5.0 psreset_ddrmem_n_3 ]
  set_property -dict [ list \
CONFIG.C_AUX_RST_WIDTH {1} \
CONFIG.C_EXT_RST_WIDTH {1} \
 ] $psreset_ddrmem_n_3
  ...
  set psreset_ddrmem_n_4 [ create_bd_cell -type ip -vlnv xilinx.com:ip:proc_sys_reset:5.0 psreset_ddrmem_n_4 ]
  set_property -dict [ list \
CONFIG.C_AUX_RST_WIDTH {1} \
CONFIG.C_EXT_RST_WIDTH {1} \
 ] $psreset_ddrmem_n_4
  ...
  set psreset_gate_pr_apmclk [ create_bd_cell -type ip -vlnv xilinx.com:ip:proc_sys_reset:5.0 psreset_gate_pr_apmclk ]
...
proc create_hier_cell_apm_sys { parentCell nameHier } {
  ...
  set regslice_apm_a [ create_bd_cell -type ip -vlnv xilinx.com:ip:axi_register_slice:2.1 regslice_apm_a ]

  # Create instance: regslice_apm_b, and set properties
  set regslice_apm_b [ create_bd_cell -type ip -vlnv xilinx.com:ip:axi_register_slice:2.1 regslice_apm_b ]

  # Create instance: regslice_fifo_a, and set properties
  set regslice_fifo_a [ create_bd_cell -type ip -vlnv xilinx.com:ip:axi_register_slice:2.1 regslice_fifo_a ]

  # Create instance: regslice_fifo_b, and set properties
  set regslice_fifo_b [ create_bd_cell -type ip -vlnv xilinx.com:ip:axi_register_slice:2.1 regslice_fifo_b ]
...
CONFIG.C_IS_DUAL {1} \
  ...
  set interconnect_axilite_static [ create_bd_cell -type ip -vlnv xilinx.com:ip:axi_interconnect:2.1 interconnect_axilite_static ]
  set_property -dict [ list \
CONFIG.NUM_MI {8} \
CONFIG.S00_HAS_REGSLICE {4} \
 ] $interconnect_axilite_static
#current_bd_instance
#create_bd_cell -type ip -vlnv xilinx.com:user:iob_static:1.0 base_region/iob_static
...
CONFIG.DIN_WIDTH {2} \
  ...
  set iob_static [ create_bd_cell -type ip -vlnv xilinx.com:user:iob_static:1.0 iob_static ]
  set startup_primitive [ create_bd_cell -type ip -vlnv xilinx.com:user:startup_wrapper:1.0 startup_primitive ]
  # Create instance: startup_primitive, and set properties
  #set iob_static [ create_bd_cell -type ip -vlnv xilinx.com:user:iob_static:1.0 iob_static iob_static ]
  # create_bd_cell -type ip -vlnv xilinx.com:user:startup_wrapper:1.0 startup_wrapper_0
  # Create interface connections
...
CONFIG.MMCM_CLKOUT0_DIVIDE_F.VALUE_SRC {DEFAULT} \
  ...
  set clkwiz_kernel2 [ create_bd_cell -type ip -vlnv xilinx.com:ip:clk_wiz:5.3 clkwiz_kernel2 ]
  set_property -dict [ list \
CONFIG.CLKOUT1_DRIVES {Buffer} \
...
CONFIG.MMCM_CLKIN2_PERIOD.VALUE_SRC {DEFAULT} \
  ...
  set clkwiz_sysclks [ create_bd_cell -type ip -vlnv xilinx.com:ip:clk_wiz:5.3 clkwiz_sysclks ]
  set_property -dict [ list \
CONFIG.CLKOUT1_DRIVES {Buffer} \
...
proc create_hier_cell_base_region { parentCell nameHier } {
  ...
  set axi_i2c [ create_bd_cell -type ip -vlnv xilinx.com:ip:axi_iic:2.0 axi_i2c ]
  set_property -dict [ list \
...
#  -string -flagsOSRD
preplace port ref_clk -pg 1 -y 790 -defaultsOSRD
preplace port spi_1_io3_io -pg 1 -y 1130 -defaultsOSRD
preplace port spi_1_io2_io -pg 1 -y 1090 -defaultsOSRD
preplace port perst_n -pg 1 -y 1090 -defaultsOSRD
preplace port c3_sys -pg 1 -y 130 -defaultsOSRD
preplace port spi_1_ss_io -pg 1 -y 1210 -defaultsOSRD
preplace port led_0 -pg 1 -y 1170 -defaultsOSRD
preplace port c0_sys -pg 1 -y 70 -defaultsOSRD
preplace port c1_ddr4 -pg 1 -y 180 -defaultsOSRD
preplace port spi_1_io0_io -pg 1 -y 1010 -defaultsOSRD
preplace port emc_clk -pg 1 -y 850 -defaultsOSRD
preplace port c3_ddr4 -pg 1 -y 240 -defaultsOSRD
preplace port c0_ddr4 -pg 1 -y 200 -defaultsOSRD
preplace port c2_ddr4 -pg 1 -y 220 -defaultsOSRD
preplace port c1_sys -pg 1 -y 90 -defaultsOSRD
preplace port spi_1_io1_io -pg 1 -y 1050 -defaultsOSRD
preplace port init_calib_complete -pg 1 -y 990 -defaultsOSRD
preplace port pcie_7x_mgt -pg 1 -y 740 -defaultsOSRD
preplace port iic -pg 1 -y 10 -defaultsOSRD
preplace port c2_sys -pg 1 -y 110 -defaultsOSRD
preplace portBus iic_reset_n -pg 1 -y 770 -defaultsOSRD
preplace inst base_region -pg 1 -lvl 1 -y 960 -defaultsOSRD
preplace inst expanded_region -pg 1 -lvl 2 -y 380 -defaultsOSRD
preplace netloc expanded_region_C0_DDR6 1 2 1 NJ
preplace netloc c3_sys_1 1 0 2 NJ 130 NJ
preplace netloc expanded_region_io2_t 1 0 3 60 1390 NJ 1390 1260
preplace netloc base_region_locked 1 1 1 630
preplace netloc base_region_clk_out3 1 1 1 600
preplace netloc Net4 1 1 2 NJ 1130 NJ
preplace netloc expanded_region_C0_DDR7 1 2 1 NJ
preplace netloc expanded_region_sck_o 1 0 3 120 1320 NJ 1320 1210
preplace netloc base_region_emc_clk_out 1 1 1 710
preplace netloc base_region_axi_aclk 1 1 1 690
preplace netloc ref_clk_1 1 0 1 NJ
preplace netloc c0_sys_1 1 0 2 NJ 70 NJ
preplace netloc base_region_IIC 1 1 2 570J 10 NJ
preplace netloc expanded_region_Dout1 1 0 3 90 630 670J 750 1170
preplace netloc base_region_M_AXI1 1 1 1 590
preplace netloc base_region_M_AXI 1 1 1 580
preplace netloc expanded_region_io1_o 1 0 3 110 1290 NJ 1290 1220
preplace netloc expanded_region_Res 1 0 3 130 1330 NJ 1330 1200
preplace netloc expanded_region_Dout2 1 0 3 150 1310 NJ 1310 1180
preplace netloc emc_clk_1 1 0 1 NJ
preplace netloc expanded_region_ss_t 1 0 3 140 1300 NJ 1300 1190
preplace netloc expanded_region_io0_o 1 0 3 30 1360 NJ 1360 1290
preplace netloc base_region_user_lnk_up 1 1 1 700
preplace netloc base_region_Dout 1 1 1 770
preplace netloc base_region_io3_i 1 1 1 750
preplace netloc expanded_region_io3_o 1 0 3 70 1400 NJ 1400 1250
preplace netloc expanded_region_dout 1 0 3 10 1340 NJ 1340 1310
preplace netloc base_region_io0_i 1 1 1 720
preplace netloc c1_sys_1 1 0 2 NJ 90 NJ
preplace netloc perst_n_1 1 0 1 NJ
preplace netloc expanded_region_io2_o 1 0 3 50 1380 NJ 1380 1270
preplace netloc expanded_region_io1_t 1 0 3 40 1370 NJ 1370 1280
preplace netloc expanded_region_dout3 1 0 3 20 1350 NJ 1350 1300
preplace netloc base_region_iob_static_perst_n_out 1 1 1 760
preplace netloc base_region_pcie_mgt 1 1 2 660J 740 NJ
preplace netloc base_region_locked1 1 1 1 680
preplace netloc base_region_io1_i 1 1 1 730
preplace netloc base_region_gpo 1 1 2 NJ 770 NJ
preplace netloc expanded_region_io0_t 1 0 3 100 1280 NJ 1280 1230
preplace netloc base_region_locked2 1 1 1 610
preplace netloc base_region_init_calib_complete_out 1 1 2 NJ 990 NJ
preplace netloc Net1 1 1 2 NJ 1010 NJ
preplace netloc Net 1 1 2 NJ 1210 NJ
preplace netloc expanded_region_C0_DDR4 1 2 1 NJ
preplace netloc base_region_led_0_out 1 1 2 NJ 1170 NJ
preplace netloc base_region_clk_out1 1 1 1 620
preplace netloc Net2 1 1 2 NJ 1050 NJ
preplace netloc expanded_region_C0_DDR5 1 2 1 NJ
preplace netloc c2_sys_1 1 0 2 NJ 110 NJ
preplace netloc slowest_sync_clk_1 1 1 1 650
preplace netloc expanded_region_io3_t 1 0 3 80 1410 NJ 1410 1240
preplace netloc base_region_io2_i 1 1 1 740
preplace netloc base_region_clk_out2 1 1 1 640
preplace netloc Net3 1 1 2 NJ 1090 NJ
levelinfo -pg 1 -10 360 970 1330 -top 0 -bot 1420
",
}
